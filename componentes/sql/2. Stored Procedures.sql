...
CREATE PROCEDURE ACTUALIZAR_USUARIO (IN VAR_ID INT, IN VAR_NOMBRE_USUARIO VARCHAR(50), IN VAR_CONTRASEÑA VARCHAR(25), IN VAR_ROLE_USUARIO INT,IN VAR_ESTADO BOOLEAN, IN VAR_CONTRASEÑA_REQUERIDA BOOLEAN)
BEGIN
